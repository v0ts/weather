    ...
    <div className={styles.weatherDetails}>
      ...
      {activeTab === 'hourly' && (
        <div className={styles.forecastSection}>
          ...
          {hourly && Array.isArray(hourly) && hourly.length > 0 ? (
            <div className={styles.hourlyChart}>
             ...
             <p className={styles.errorMessage}>Погодинний прогноз недоступний</p>
           )}
        </div>
      )}
        ...
        <div className={styles.forecastSection}>
          ...
          {daily && Array.isArray(daily) && daily.length > 0 ? (
            <div className={styles.weeklyForecast}>
             ...
             <p className={styles.errorMessage}>Тижневий прогноз недоступний</p>
           )}
        </div>
      )}
    </div>
